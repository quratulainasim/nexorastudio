  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-7xl font-bold neon-text text-primary">404</h1>
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-gradient-brand px-6 py-2.5 text-sm font-medium text-primary-foreground shadow-glow transition hover:opacity-90"
          >
            Go home
          </Link>
        </div>
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:site", content: "@nexorastudio" },
      { name: "theme-color", content: "#0d2926" },
    ],
    links: [
      {
        rel: "stylesheet",
